...
```typescript:extension.ts:blogs/vscode/10.我不知道的 VSCode 扩展：效率利器：模板与工具.mdx
...
```html:webview/index.html:blogs/vscode/10.我不知道的 VSCode 扩展：效率利器：模板与工具.mdx
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <vscode-button appearance="primary">Click Me</vscode-button>  <!-- 使用 vscode-button 组件 -->
</body>
</html>
```
